...
function getNpmInfo(npmName, registry) {
    return __awaiter(this, void 0, void 0, function () {
        var registryUrl, npmInfoUrl, res, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    registryUrl = registry || getDefaultRegistry(true);
                    npmInfoUrl = urlJoin(registryUrl, npmName);
                    console.log("npmInfoUrl", npmInfoUrl);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios.get(npmInfoUrl)];
                case 2:
                    res = _a.sent();
...
function getNpmVersions(npmName, registry) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getNpmInfo(npmName, registry)];
                case 1:
                    data = _a.sent();
                    if (data) {
                        return [2 /*return*/, Object.keys(data.versions)];
                    }
                    else {
                        return [2 /*return*/, []];
                    }
...
function getNpmSemverVersions(baseVersion, versions) {
    var lastVersions = versions.filter(function (version) {
        return semver$1.satisfies(version, "^".concat(baseVersion));
    });
...
function getNpmSemverVersion(baseVersion, npmName, registry) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getNpmVersions(npmName, registry)];
                case 1:
                    versions = _a.sent();
                    newVersions = getNpmSemverVersions(baseVersion, versions);
                    if (newVersions && newVersions.length > 0) {
                        return [2 /*return*/, newVersions[0]];
                    }
                    return [2 /*return*/];
            }
        });
...
// 用户主目录检查功能
var checkUserHome = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, pathExists(userHome)];
            case 1:
                _a = !(_b.sent());
                _b.label = 2;
            case 2:
...
var checkEnv = function () { return __awaiter(void 0, void 0, void 0, function () {
    var dotenv, dotenvPath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                dotenv = require("dotenv");
                dotenvPath = path.resolve(userHome, ".env");
                return [4 /*yield*/, pathExists(dotenvPath)];
            case 1:
                if (_a.sent()) {
                    dotenv.config({
                        path: dotenvPath
...
function checkGlobalUpdate() {
    return __awaiter(this, void 0, void 0, function () {
        var curVersion, npmName, lastVersion;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    curVersion = pkg.version;
                    npmName = pkg.name;
                    return [4 /*yield*/, getNpmSemverVersion(curVersion, npmName)];
                case 1:
                    lastVersion = _a.sent();
                    if (lastVersion && semver.gt(lastVersion, curVersion)) {
                        log.warn(colors.yellow("\u66F4\u65B0\u63D0\u793A: \u8BF7\u624B\u52A8\u66F4\u65B0\n      \u5F53\u524D\u7248\u672C: v".concat(curVersion, ", \u6700\u65B0\u7248\u672C:v").concat(lastVersion, "\n      \u66F4\u65B0\u547D\u4EE4: npm install -g ").concat(npmName)));
                    }
                    else {
